...
#define SYSENTER_CS		0x174	// 16-bit
#define SYSENTER_ESP	0x175	// 32-bit
#define SYSENTER_EIP	0x176	// 32-bit
#define PAT				0x277
#define PERF_GLOBAL_CTRL	0xc000038f
#define BNDCFGS			0xc0000d90

#define DEBUG_CTL			0xC00001d9	// It's different from svm
...
/*#define LAST_BRANCH_FROM_IP	0x1db
#define LAST_BRANCH_TO_IP	0x1dc
#define LAST_INT_FROM_IP	0x1dd
#define LAST_INT_TO_IP		0x1de*/
...
//asmlinkage void rv_jump_to_revirt_switch_code(unsigned long rip);
...
/*inline void rv_jump_to_revirt_switch_code_wrapper(unsigned long rip)
{
	rv_jump_to_revirt_switch_code(rip);
}*/
