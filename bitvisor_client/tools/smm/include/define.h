...
#define MAPPEDAREASIZE (0x2fffff)    /* this is the size of the mapped SMRAM area (in bytes */ 
#define TSEG_MAP_SIZE (0xffffff)    /* this is the size of the mapped SMRAM area (in bytes */          
