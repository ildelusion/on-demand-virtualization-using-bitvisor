#SHARED_AREA_HRIV				= 0xffff884049003000
...
#SHARED_AREA_MISC				= 0xffff884049003800
...
# vaddr for HRIV and MISC area should be changed to Hosts'.
#mov OFFSET_MISC_HOST_HRIV_VADDR(%rsi), %rax
#mov OFFSET_MISC_HOST_MISC_VADDR(%rsi), %rcx

### Serial Print (using mov) ####
# Store rax and rdx.#			#
mov %rax, %r12					#
mov %rdx, %r13					#
# Write to serial.				#
